...
class AQL
{
     ...
     *
     * It is the `agg` counterpart of {@see AQL::GROUPABLE}, but it keys on the
     ...
     * behaviour. Declaring it closes the gate; {@see AQL::AGGREGATABLE_POLICY}
     ...
     * is absent from {@see AQL::AGGREGATABLE}. One of the
