...
3. **Déclarer la View au modèle** — chaque modèle inspecté porte son bloc `AQL::VIEW` (`Search::NAME` / `Search::ANALYZER` / `Search::FIELDS`, voir [Recherche View](../db/search/overview.md)).
