...
|---|---|---|
| Barre de recherche avec pertinence | match `TOKENS` + `BM25` | [bloc `AQL::VIEW`](../db/search/README.md), automatique |
...
| Bloc `AQL::VIEW` du modèle | `?search=` bascule sur la View, auto-provisioning, clé de tri `score`, totaux & facet counts synchronisés | [Recherche View](../db/search/README.md) |
...
- [Recherche View (ArangoSearch)](../db/search/README.md) — la recette modèle (`AQL::VIEW`, URLs, réponses JSON).
