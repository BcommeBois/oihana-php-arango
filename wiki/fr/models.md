...
|---|---|---|
| `beforeModelCall( $request , array &$init )` | Avant chaque opération CRUD du contrôleur. | Injection de filtres, *authorizer* custom (le défaut est déjà posé par la base), validation transverse. |
