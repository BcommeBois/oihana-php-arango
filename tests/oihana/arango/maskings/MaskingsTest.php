...
namespace tests\oihana\arango\maskings;

use InvalidArgumentException;

use PHPUnit\Framework\TestCase;

use function oihana\arango\maskings\maskCreditCard;
...
use function oihana\arango\maskings\maskRandom;
use function oihana\arango\maskings\maskRandomString;
use function oihana\arango\maskings\maskValue;
use function oihana\arango\maskings\maskXifyFront;
use function oihana\arango\maskings\maskZip;
use function oihana\arango\maskings\randomAlphaNumeric;

/**
 * Unit coverage for the portable masking engine ({@see oihana\arango\maskings}).
 */
